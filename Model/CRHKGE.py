...
class CRHKGE(KGAT):
    ...
    def export_artifacts(self, sess, args, data_generator, final_perf):
        ...
        model_config = {
            ...
            'n_relations_expanded': self.n_relations,
            ...
            'enriched_product_count': len(self.cr_config.get('enriched_product_ids', [])),
            'global_attr_relation_ids': self.cr_global_attr_relation_ids,
